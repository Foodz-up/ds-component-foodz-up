...
var __vue_render__ = function __vue_render__() {
  ...
  }, [_vm._ssrNode("<p data-v-2f7d1a2c>" + _vm._ssrEscape("The counter was " + _vm._s(_vm.changedBy) + " to ") + "<b data-v-2f7d1a2c>" + _vm._ssrEscape(_vm._s(_vm.counter)) + "</b>.</p> <button data-v-2f7d1a2c>\n    Click +1\n  </button> <button data-v-2f7d1a2c>\n    Click -1\n  </button> <button data-v-2f7d1a2c>\n    Click +5\n  </button> <button data-v-2f7d1a2c>\n    Click -5\n  </button> <button data-v-2f7d1a2c>\n    Reset\n  </button>")]);
};
...
var __vue_inject_styles__ = function __vue_inject_styles__(inject) {
  if (!inject) return;
  inject("data-v-2f7d1a2c_0", {
    source: ".ds-component-foodz-up-sample[data-v-2f7d1a2c]{display:block;width:400px;margin:25px auto;border:1px solid #ccc;background:#eaeaea;text-align:center;padding:25px}.ds-component-foodz-up-sample p[data-v-2f7d1a2c]{margin:0 0 1em}",
    map: undefined,
    media: undefined
  });
};
...
var __vue_scope_id__ = "data-v-2f7d1a2c";
/* module identifier */

var __vue_module_identifier__ = "data-v-2f7d1a2c";
/* functional template */
...
var components=/*#__PURE__*/Object.freeze({__proto__:null,'default': install,DsComponentFoodzUpSample: __vue_component__});// only expose one global var, with component exports exposed as properties of
